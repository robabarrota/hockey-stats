...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsTopScorersTopScorersComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsTopScorersTopScorersComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsTopScorersTopScorersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TopScorersComponent", function () {
      return TopScorersComponent;
    });
    /* harmony import */
    ...
    var src_app_Models_PlayerStat__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/Models/PlayerStat */
    "./src/app/Models/PlayerStat.ts");
    /* harmony import */


    var src_app_Services_player_player_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/Services/player/player.service */
    ...
    var _assets_weightedStats_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../assets/weightedStats.json */
    "./src/assets/weightedStats.json");

    var _assets_weightedStats_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../../../assets/weightedStats.json */
    "./src/assets/weightedStats.json", 1);
    /* harmony import */
    ...
    var src_app_Models_TeamStat__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/Models/TeamStat */
    "./src/app/Models/TeamStat.ts");

    var TopScorersComponent = /*#__PURE__*/function () {
      function TopScorersComponent(playerService, teamService) {
        _classCallCheck(this, TopScorersComponent);
      ...
      _createClass(TopScorersComponent, [{
        key: "ngOnInit",
        ...
        key: "todaysPlayers",
        value: function todaysPlayers() {
          this.getRosters();
        }
      }, {
        key: "getRosters",
        value: function getRosters() {
          var _this = this;

          this.clearAll();
          var schedule;
          this.teamService.playingTeams().subscribe(function (scheduleObs) {
            return schedule = scheduleObs;
          }, function () {}, function () {
            _this.loadTodaysTeams(schedule.dates[0].games);

            _this.loadTeamStatsAndRankings();
        ...
        key: "loadTodaysTeams",
        value: function loadTodaysTeams(games) {
          var _this2 = this;
          ...
          games.forEach(function (game) {
            ...
            _this2.games.push(newGame);
          });
          this.teams = teams;
        }
      }, {
        key: "loadRosters",
        value: function loadRosters() {
          var _this3 = this;
          ...
          var rostersResponse;
          this.playerService.getRosters(teamIds).subscribe(function (rostersObs) {
            return rostersResponse = rostersObs;
          }, function () {}, function () {
            var rosters = [];
            var teams = rostersResponse.teams;
            teams.forEach(function (team) {
              var thisGame = _this3.games.filter(function (game) {
                return game.homeTeam.id === team.id || game.awayTeam.id === team.id;
              })[0];
              ...
              teamRoster.forEach(function (rosterSpot) {
                ...
                _this3.playerService.getPlayerSeasonStats(playerId).subscribe(function (playerSeasonStatsResponse) {
                  return playerSeasonStatsresp = playerSeasonStatsResponse;
                }, function () {}, function () {
                  ...
                  _this3.playerService.getPlayerPlayoffStats(playerId).subscribe(function (playerPlayoffStatsResponse) {
                    return playerPlayoffStatsresp = playerPlayoffStatsResponse;
                  }, function () {}, function () {
                    ...
                    _this3.calculateGoalLikelihood(player);

                    roster.players.push(player);

                    _this3.orderedPlayers.push(player);
                  });
                });
              });
              rosters.push(roster);
            });
            _this3.rosters = rosters;
          });
        }
      }, {
        key: "clearAll",
        ...
        key: "calculateRank",
        value: function calculateRank() {
          var _this4 = this;

          this.orderedPlayers.forEach(function (player) {
            _this4.calculateGoalLikelihood(player);
          });
        }
      }, {
        key: "orderPlayers",
        value: function orderPlayers() {
          //this.orderedPlayers.filter((a) => a.goalLikelihoodRank > 0);
          this.orderedPlayers.sort(function (a, b) {
            return b.goalLikelihoodRank - a.goalLikelihoodRank;
          });
        }
      }, {
        key: "getGoalsPerGame",
        value: function getGoalsPerGame(stats) {
          return stats.games === 0 ? 0 : stats.goals / stats.games;
        }
      }, {
        key: "calculateGoalLikelihood",
        value: function calculateGoalLikelihood(player) {
          var _this5 = this;

          var playerSeasonStatsResp, playerPlayoffStatsResp;
          this.playerService.getPlayerSeasonStats(player.id).subscribe(function (playerSeasonStatsResponse) {
            return playerSeasonStatsResp = playerSeasonStatsResponse;
          }, function () {}, function () {
            _this5.playerService.getPlayerPlayoffStats(player.id).subscribe(function (playerPlayoffStatsResponse) {
              return playerPlayoffStatsResp = playerPlayoffStatsResponse;
            }, function () {}, function () {
              console.log("here"); // if (playerSeasonStatsResp.stats[0].splits[0] !== undefined && playerPlayoffStatsResp.stats[0].splits[0] !== undefined) {

              if (playerSeasonStatsResp.stats[0].splits[0] !== undefined) {
                console.log("there");
                var playerSeasonStats = playerSeasonStatsResp.stats[0].splits[0].stat; //var playerPlayoffStats = playerPlayoffStatsResp.stats[0].splits[0].stat;
                ...
                player.goalLikelihoodRank = _this5.getGoalsPerGameScore(playerTotalGoals, playerTotalGames) //+ this.getGeneralPlayerRank(playerStats.rankShots) *  this.getGeneralPlayerRank(playerStats.rankShotPct) * this.weightedStats.shotPercentageWeight
                + _this5.getOpposingGoalsAgainstScore(_this5.teams.find(function (team) {
                  return team.id === player.playingAgainst.id;
                }).stats.goalsAgainstPerGame) + _this5.getPowerPlayScore(_this5.teams.find(function (team) {
                  return team.id === player.playingAgainst.id;
                }).rankings.penaltyKillOpportunities, _this5.teams.find(function (team) {
                  return team.id === player.playingAgainst.id;
                }).stats.penaltyKillPercentage, _this5.teams.find(function (team) {
                  return team.id === player.playingAgainst.id;
                }).stats.gamesPlayed, playerTotalPPG, playerTotalGames);
              } else {
        ...
        key: "rankingStringToNumber",
        value: function rankingStringToNumber(rank) {
          return rank ? Number(rank.slice(0, -2)) : 800;
        }
      }, {
        key: "getGeneralPlayerRank",
        value: function getGeneralPlayerRank(rank) {
        ...
        key: "getOpposingGoalsAgainstScore",
        value: function getOpposingGoalsAgainstScore(gaa) {
        ...
        key: "normalizePlayerRankValue",
        value: function normalizePlayerRankValue(rankValue) {
        ...
        key: "normalizeTeamRankValue",
        value: function normalizeTeamRankValue(rankValue) {
          var normalizedRankScore = (rankValue - this.minRank) / (this.maxTeamRank - this.minRank);
          return !isNaN(normalizedRankScore) ? normalizedRankScore : 1;
        }
      }, {
        key: "normalizePlayerStatValue",
        value: function normalizePlayerStatValue(playerStat, min, max) {
          var normalizedScore = (playerStat - min) / (max - min);
          return !isNaN(normalizedScore) ? normalizedScore : 1;
        }
      }, {
        key: "normalizeTeamStatValue",
        value: function normalizeTeamStatValue(teamStat, min, max) {
          var normalizedScore = (teamStat - min) / (max - min);
          return !isNaN(normalizedScore) ? normalizedScore : 1;
        }
      }, {
        key: "getGoalsPerGameScore",
        value: function getGoalsPerGameScore(goals, games) {
          ...
          var goalsPerGameScore = (goalsPerGameValue + gamesValue) * this.weightedStats.goalsPerGameWeight; // var goalsValue = this.normalizePlayerStatValue(goals, this.worstPlayerStats.goals, this.topPlayerStats.goals);
        ...
        key: "getPowerPlayScore",
        value: function getPowerPlayScore(pkOps, pkPerc, teamGames, ppGoals, playerGames) {
        ...
        key: "loadTeamStatsAndRankings",
        value: function loadTeamStatsAndRankings() {
          var _this6 = this;

          this.teams.forEach(function (team) {
            var teamStatsResp;

            _this6.teamService.getTeamStats(team.id).subscribe(function (teamStatsObs) {
              return teamStatsResp = teamStatsObs;
            }, function () {}, function () {
        ...
        value: function loadGames() {
          ...
          this.teamService.playingTeams().subscribe(function (scheduleObs) {
            ...
            _this7.loadTodaysTeams(schedule.dates[0].games);
        ...
        value: function exportToExcel() {
          ...
          var element = document.getElementById('prediction-data');
        ...
        key: "getMaxMinData",
        value: function getMaxMinData() {
          var _this8 = this;

          var allTeamsResp;
          this.teamService.getAllTeams().subscribe(function (allTeamsObs) {
            return allTeamsResp = allTeamsObs;
          }, function () {}, function () {
            var allTeamsObjs = allTeamsResp.teams;
            var teamIds = allTeamsObjs.map(function (team) {
              return team.id;
            });
            var rostersResponse;

            _this8.playerService.getRosters(teamIds).subscribe(function (rostersObs) {
              return rostersResponse = rostersObs;
            }, function () {}, function () {
              var teams = rostersResponse.teams;
              teams.forEach(function (team) {
                ...
                teamRoster.forEach(function (rosterSpot) {
                  ...
                  _this8.playerService.getPlayerSeasonStats(playerId).subscribe(function (playerSeasonStatsResponse) {
                    return playerSeasonStatsresp = playerSeasonStatsResponse;
                  }, function () {}, function () {
                    _this8.playerService.getPlayerPlayoffStats(playerId).subscribe(function (playerPlayoffStatsResponse) {
                      return playerPlayoffStatsresp = playerPlayoffStatsResponse;
                    }, function () {}, function () {
                      var playerSeasonStat = playerSeasonStatsresp.stats[0].splits.length === 0 ? new src_app_Models_PlayerStat__WEBPACK_IMPORTED_MODULE_2__["PlayerStat"]() : playerSeasonStatsresp.stats[0].splits[0].stat;
                      var playerPlayoffStat = playerPlayoffStatsresp.stats[0].splits.length === 0 ? new src_app_Models_PlayerStat__WEBPACK_IMPORTED_MODULE_2__["PlayerStat"]() : playerPlayoffStatsresp.stats[0].splits[0].stat; // var goals = playerSeasonStat.goals + playerPlayoffStat.games == undefined ? playerPlayoffStat.games : 0;
                      ...
                      if (goals > _this8.topPlayerStats.goals) {
                        _this8.topPlayerStats.goals = goals;
                      } else if (goals < _this8.worstPlayerStats.goals) {
                        _this8.worstPlayerStats.goals = goals;
                      }

                      if (games > _this8.topPlayerStats.games) {
                        _this8.topPlayerStats.games = games;
                      } else if (games < _this8.worstPlayerStats.games) {
                        _this8.worstPlayerStats.games = games;
                      }

                      if (powerPlayGoals > _this8.topPlayerStats.powerPlayGoals) {
                        _this8.topPlayerStats.powerPlayGoals = powerPlayGoals;
                      } else if (powerPlayGoals < _this8.worstPlayerStats.powerPlayGoals) {
                        _this8.worstPlayerStats.powerPlayGoals = powerPlayGoals;
                      }

                      if (goalsPerGame > _this8.topPlayerStats.goalsPerGame) {
                        _this8.topPlayerStats.goalsPerGame = goalsPerGame;
                      } else if (goalsPerGame < _this8.worstPlayerStats.goalsPerGame) {
                        _this8.worstPlayerStats.goalsPerGame = goalsPerGame;
                      }
                    });
                  });
                });
            ...
            allTeamsObjs.forEach(function (teamObj) {
              ...
              var pkfreq = _this8.rankingStringToNumber(pkopsRank) / gamesPlayed;

              if (pkfreq < _this8.topTeamStats.penaltyKillFrequency) {
                _this8.topTeamStats.penaltyKillFrequency = pkfreq;
              } else if (pkfreq > _this8.worstTeamStats.penaltyKillFrequency) {
                _this8.worstTeamStats.penaltyKillFrequency = pkfreq;
              }

              if (pkperc < _this8.topTeamStats.penaltyKillPercentage) {
                _this8.topTeamStats.penaltyKillPercentage = pkperc;
              } else if (pkperc > _this8.worstTeamStats.penaltyKillPercentage) {
                _this8.worstTeamStats.penaltyKillPercentage = pkperc;
              }

              if (gaa < _this8.topTeamStats.goalsAgainstPerGame) {
                _this8.topTeamStats.goalsAgainstPerGame = gaa;
              } else if (gaa > _this8.worstTeamStats.goalsAgainstPerGame) {
                _this8.worstTeamStats.goalsAgainstPerGame = gaa;
              }

              if (gamesPlayed < _this8.topTeamStats.gamesPlayed) {
                _this8.topTeamStats.gamesPlayed = gamesPlayed;
              } else if (gamesPlayed > _this8.worstTeamStats.gamesPlayed) {
                _this8.worstTeamStats.gamesPlayed = gamesPlayed;
              }
            });
            _this8.loadingStatistics = false;
          });
        }
      }]);
    ...
    TopScorersComponent.ctorParameters = function () {
      return [{
    ...
    TopScorersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-top-scorers',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./top-scorers.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/top-scorers/top-scorers.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./top-scorers.component.scss */
      "./src/app/Components/top-scorers/top-scorers.component.scss"))["default"]]
    })], TopScorersComponent);
    /***/
  },
  ...
  /***/
  function srcAppModelsPlayerStatTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PlayerStat", function () {
      return PlayerStat;
    });
    /* harmony import */
    ...
    var PlayerStat = function PlayerStat() {
  ...
  /***/
  function srcAppModelsTeamStatTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TeamStat", function () {
      return TeamStat;
    });
    /* harmony import */
    ...
    var TeamStat = function TeamStat() {
      _classCallCheck(this, TeamStat);
    };
    /***/
  ...
  /***/
  function srcAppServicesPlayerPlayerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _assets_appsettings_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../../assets/appsettings.json */
    "./src/assets/appsettings.json");

    var _assets_appsettings_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../../../assets/appsettings.json */
    "./src/assets/appsettings.json", 1);
    ...
    var PlayerService = /*#__PURE__*/function () {
      ...
      _createClass(PlayerService, [{
        key: "getRosters",
        value: function getRosters(teamIds) {
    ...
    PlayerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    })], PlayerService);
    /***/
  },
  ...
  function srcAppServicesTeamTeamServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _assets_appsettings_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../../assets/appsettings.json */
    "./src/assets/appsettings.json");

    var _assets_appsettings_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(
    /*! ../../../assets/appsettings.json */
    "./src/assets/appsettings.json", 1);
    ...
    var TeamService = /*#__PURE__*/function () {
      ...
      _createClass(TeamService, [{
        ...
        key: "getTeamStats",
        value: function getTeamStats(teamId) {
    ...
    TeamService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])({
      providedIn: 'root'
    })], TeamService);
    /***/
  },
  ...
  function srcAppAppMaterialAppMaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppMaterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [],
      imports: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MatExpansionModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]],
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Components_top_scorers_top_scorers_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./Components/top-scorers/top-scorers.component */
    "./src/app/Components/top-scorers/top-scorers.component.ts");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Components_top_scorers_top_scorers_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./Components/top-scorers/top-scorers.component */
    "./src/app/Components/top-scorers/top-scorers.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _Components_top_scorers_top_scorers_component__WEBPACK_IMPORTED_MODULE_5__["TopScorersComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _app_material_app_material_module__WEBPACK_IMPORTED_MODULE_8__["AppMaterialModule"]],
      providers: [],
  ...
  /***/
  function srcAssetsAppsettingsJson(module) {
  ...
  /***/
  function srcAssetsWeightedStatsJson(module) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/robabarrota/Desktop/hockey-stats/src/main.ts */
    "./src/main.ts");
    /***/
  },
